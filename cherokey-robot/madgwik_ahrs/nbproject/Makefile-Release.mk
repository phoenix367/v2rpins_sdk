...
${TESTDIR}/tests/QuaternionOperations.o: tests/QuaternionOperations.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${TESTDIR}/tests/QuaternionOperations.o tests/QuaternionOperations.cpp


${TESTDIR}/tests/quaternion_operations.o: tests/quaternion_operations.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${TESTDIR}/tests/quaternion_operations.o tests/quaternion_operations.cpp
