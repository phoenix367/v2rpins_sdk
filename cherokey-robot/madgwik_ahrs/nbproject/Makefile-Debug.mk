...
${OBJECTDIR}/src/madgwik_ahrs.o: src/madgwik_ahrs.c 
	...
	${RM} $@.d
	$(COMPILE.c) -g -Iinclude -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/madgwik_ahrs.o src/madgwik_ahrs.c
...
${TESTDIR}/tests/QuaternionOperations.o: tests/QuaternionOperations.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${TESTDIR}/tests/QuaternionOperations.o tests/QuaternionOperations.cpp


${TESTDIR}/tests/quaternion_operations.o: tests/quaternion_operations.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -g `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${TESTDIR}/tests/quaternion_operations.o tests/quaternion_operations.cpp


${TESTDIR}/tests/TestEuler.o: tests/TestEuler.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -g `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${TESTDIR}/tests/TestEuler.o tests/TestEuler.cpp


${TESTDIR}/tests/euler_test.o: tests/euler_test.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -g `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${TESTDIR}/tests/euler_test.o tests/euler_test.cpp
...
${OBJECTDIR}/src/madgwik_ahrs_nomain.o: ${OBJECTDIR}/src/madgwik_ahrs.o src/madgwik_ahrs.c 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.c) -g -Iinclude -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/madgwik_ahrs_nomain.o src/madgwik_ahrs.c;\
	else  \
