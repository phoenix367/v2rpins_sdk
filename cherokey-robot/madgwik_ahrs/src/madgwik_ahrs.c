...
void MadgwickAHRSupdate(float gx, float gy, float gz, float ax, float ay, 
	...
	if(!((ax == 0.0f) && (ay == 0.0f) && (az == 0.0f))) {
		...
		hx = mx * q0q0 - _2q0my * ahrs->q3 + _2q0mz * ahrs->q2 + mx * q1q1 + 
                _2q1 * my * ahrs->q2 + _2q1 * mz * ahrs->q3 - mx * q2q2 - 
                mx * q3q3;
		hy = _2q0mx * ahrs->q3 + my * q0q0 - _2q0mz * ahrs->q1 + 
                _2q1mx * ahrs->q2 - my * q1q1 + my * q2q2 + 
                _2q2 * mz * ahrs->q3 - my * q3q3;
		_2bx = sqrt(hx * hx + hy * hy);
		_2bz = -_2q0mx * ahrs->q2 + _2q0my * ahrs->q1 + mz * q0q0 + 
                _2q1mx * ahrs->q3 - mz * q1q1 + _2q2 * my * ahrs->q3 - 
                mz * q2q2 + mz * q3q3;
		_4bx = 2.0f * _2bx;
		_4bz = 2.0f * _2bz;
		...
		s0 = -_2q2 * (2.0f * q1q3 - _2q0q2 - ax) + _2q1 * (2.0f * q0q1 + _2q2q3 - ay) - 
                _2bz * ahrs->q2 * (_2bx * (0.5f - q2q2 - q3q3) + 
                _2bz * (q1q3 - q0q2) - mx) + (-_2bx * ahrs->q3 + _2bz * ahrs->q1) * 
                (_2bx * (q1q2 - q0q3) + _2bz * (q0q1 + q2q3) - my) + 
                _2bx * ahrs->q2 * (_2bx * (q0q2 + q1q3) + _2bz * (0.5f - q1q1 - q2q2) - mz);
		s1 = _2q3 * (2.0f * q1q3 - _2q0q2 - ax) + _2q0 * (2.0f * q0q1 + _2q2q3 - ay) - 
                4.0f * ahrs->q1 * (1 - 2.0f * q1q1 - 2.0f * q2q2 - az) + 
                _2bz * ahrs->q3 * (_2bx * (0.5f - q2q2 - q3q3) + _2bz * (q1q3 - q0q2) - mx) + 
                (_2bx * ahrs->q2 + _2bz * ahrs->q0) * (_2bx * (q1q2 - q0q3) + 
                _2bz * (q0q1 + q2q3) - my) + (_2bx * ahrs->q3 - _4bz * ahrs->q1) * (_2bx * (q0q2 + q1q3) + _2bz * (0.5f - q1q1 - q2q2) - mz);
		s2 = -_2q0 * (2.0f * q1q3 - _2q0q2 - ax) + _2q3 * (2.0f * q0q1 + _2q2q3 - ay) - 
                4.0f * ahrs->q2 * (1 - 2.0f * q1q1 - 2.0f * q2q2 - az) + 
                (-_4bx * ahrs->q2 - _2bz * ahrs->q0) * (_2bx * (0.5f - q2q2 - q3q3) + 
                _2bz * (q1q3 - q0q2) - mx) + (_2bx * ahrs->q1 + _2bz * ahrs->q3) * 
                (_2bx * (q1q2 - q0q3) + _2bz * (q0q1 + q2q3) - my) + 
                (_2bx * ahrs->q0 - _4bz * ahrs->q2) * (_2bx * (q0q2 + q1q3) + _2bz * (0.5f - q1q1 - q2q2) - mz);
		s3 = _2q1 * (2.0f * q1q3 - _2q0q2 - ax) + _2q2 * (2.0f * q0q1 + _2q2q3 - ay) + 
                (-_4bx * ahrs->q3 + _2bz * ahrs->q1) * (_2bx * (0.5f - q2q2 - q3q3) + 
                _2bz * (q1q3 - q0q2) - mx) + (-_2bx * ahrs->q0 + _2bz * ahrs->q2) * 
                (_2bx * (q1q2 - q0q3) + _2bz * (q0q1 + q2q3) - my) + 
                _2bx * ahrs->q1 * (_2bx * (q0q2 + q1q3) + _2bz * (0.5f - q1q1 - q2q2) - mz);
	...
	ahrs->q0 += qDot1 * (1.0f / ahrs->sampleFreq);
	ahrs->q1 += qDot2 * (1.0f / ahrs->sampleFreq);
	ahrs->q2 += qDot3 * (1.0f / ahrs->sampleFreq);
	ahrs->q3 += qDot4 * (1.0f / ahrs->sampleFreq);

	// Normalise quaternion
	recipNorm = invSqrt(ahrs->q0 * ahrs->q0 + ahrs->q1 * ahrs->q1 + 
...
void MadgwickAHRSupdateIMU(float gx, float gy, float gz, float ax, float ay, 
	...
	if(!((ax == 0.0f) && (ay == 0.0f) && (az == 0.0f))) {
		...
		s1 = _4q1 * q3q3 - _2q3 * ax + 4.0f * q0q0 * ahrs->q1 - _2q0 * ay - 
