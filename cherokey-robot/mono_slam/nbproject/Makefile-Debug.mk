...
${TESTDIR}/tests/slamFuncTest.o: tests/slamFuncTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -g -Iinclude -std=c++0x `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${TESTDIR}/tests/slamFuncTest.o tests/slamFuncTest.cpp


${TESTDIR}/tests/slamTest.o: tests/slamTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -g -Iinclude -std=c++0x `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${TESTDIR}/tests/slamTest.o tests/slamTest.cpp


${TESTDIR}/tests/VfunctionsTest.o: tests/VfunctionsTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -g -Iinclude -std=c++0x `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${TESTDIR}/tests/VfunctionsTest.o tests/VfunctionsTest.cpp


${TESTDIR}/tests/vfunctions_test.o: tests/vfunctions_test.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -g -Iinclude -std=c++0x `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${TESTDIR}/tests/vfunctions_test.o tests/vfunctions_test.cpp
...
${OBJECTDIR}/src/slam_functions_nomain.o: ${OBJECTDIR}/src/slam_functions.o src/slam_functions.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -g -Iinclude -std=c++0x -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/slam_functions_nomain.o src/slam_functions.cpp;\
	else  \
...
${OBJECTDIR}/src/vector_function_nomain.o: ${OBJECTDIR}/src/vector_function.o src/vector_function.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -g -Iinclude -std=c++0x -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/vector_function_nomain.o src/vector_function.cpp;\
	else  \
