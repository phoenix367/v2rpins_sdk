...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Wed Mar 5 00:50:50 2014
...
LINK          = g++
LFLAGS        = -m64
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -L/usr/X11R6/lib64 -lprotobuf -lzmq -lGLU ../qwtplot3d/dist/Debug/GNU-Linux-x86/libqwtplot3d.a -lQtGStreamerUi-0.10 -lQtGStreamerUtils-0.10 -lQtGStreamer-0.10 -lQtGLib-2.0 -lQtOpenGL -lQtGui -lQtNetwork -lQtCore -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
QMAKE         = /usr/bin/qmake
TAR           = tar -cf
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/Debug/GNU-Linux-x86/RobotControl1.0.0/ && $(COPY_FILE) --parents Commands.hpp Globals.hpp GraphPlot.hpp IP4Validator.hpp OdometrySink.hpp PlatformModel.hpp PortValidator.hpp RemoteConnector.hpp SensorsConnector.hpp messages/common.pb.h messages/sensors.pb.h ui/MainForm.hpp build/Debug/GNU-Linux-x86/RobotControl1.0.0/ && $(COPY_FILE) --parents Commands.cpp GraphPlot.cpp IP4Validator.cpp OdometrySink.cpp PlatformModel.cpp PortValidator.cpp RemoteConnector.cpp SensorsConnector.cpp main.cpp messages/common.pb.cc messages/sensors.pb.cc ui/MainForm.cpp build/Debug/GNU-Linux-x86/RobotControl1.0.0/ && $(COPY_FILE) --parents ui/MainForm.ui build/Debug/GNU-Linux-x86/RobotControl1.0.0/ && (cd `dirname build/Debug/GNU-Linux-x86/RobotControl1.0.0` && $(TAR) RobotControl1.0.0.tar RobotControl1.0.0 && $(COMPRESS) RobotControl1.0.0.tar) && $(MOVE) `dirname build/Debug/GNU-Linux-x86/RobotControl1.0.0`/RobotControl1.0.0.tar.gz . && $(DEL_FILE) -r build/Debug/GNU-Linux-x86/RobotControl1.0.0
