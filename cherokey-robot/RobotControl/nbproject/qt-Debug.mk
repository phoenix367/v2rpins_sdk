...
# Generated by qmake (2.01a) (Qt 4.6.2) on: ?? ???. 8 01:51:56 2014
...
INCPATH       = -I/usr/share/qt4/mkspecs/linux-g++ -Inbproject -I/usr/include/qt4/QtCore -I/usr/include/qt4/QtGui -I/usr/include/qt4 -Iui -Imessages -I../../3pty/include -Imoc -Iui -I.
LINK          = g++
LFLAGS        = 
LIBS          = $(SUBLIBS)  -L/usr/lib -lprotobuf -lzmq -lQtGui -lQtCore -lpthread 
AR            = ar cqs
RANLIB        = 
QMAKE         = /usr/bin/qmake
TAR           = tar -cf
...
OBJECTS       = build/Debug/GNU-Linux-x86/Commands.o \
		...
		build/Debug/GNU-Linux-x86/SensorsListener.o \
		...
		build/Debug/GNU-Linux-x86/moc_SensorsListener.o \
...
dist: 
	@$(CHK_DIR_EXISTS) nbproject/build/Debug/GNU-Linux-x86/RobotControl1.0.0 || $(MKDIR) nbproject/build/Debug/GNU-Linux-x86/RobotControl1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) nbproject/build/Debug/GNU-Linux-x86/RobotControl1.0.0/ && $(COPY_FILE) --parents Commands.hpp Globals.hpp IP4Validator.hpp PortValidator.hpp RemoteConnector.hpp SensorsConnector.hpp SensorsListener.hpp messages/common.pb.h messages/sensors.pb.h ui/MainForm.hpp nbproject/build/Debug/GNU-Linux-x86/RobotControl1.0.0/ && $(COPY_FILE) --parents Commands.cpp IP4Validator.cpp PortValidator.cpp RemoteConnector.cpp SensorsConnector.cpp SensorsListener.cpp main.cpp messages/common.pb.cc messages/sensors.pb.cc ui/MainForm.cpp nbproject/build/Debug/GNU-Linux-x86/RobotControl1.0.0/ && $(COPY_FILE) --parents ui/MainForm.ui nbproject/build/Debug/GNU-Linux-x86/RobotControl1.0.0/ && (cd `dirname nbproject/build/Debug/GNU-Linux-x86/RobotControl1.0.0` && $(TAR) RobotControl1.0.0.tar RobotControl1.0.0 && $(COMPRESS) RobotControl1.0.0.tar) && $(MOVE) `dirname nbproject/build/Debug/GNU-Linux-x86/RobotControl1.0.0`/RobotControl1.0.0.tar.gz . && $(DEL_FILE) -r nbproject/build/Debug/GNU-Linux-x86/RobotControl1.0.0
...
compiler_moc_header_make_all: moc/moc_IP4Validator.cpp moc/moc_PortValidator.cpp moc/moc_RemoteConnector.cpp moc/moc_SensorsConnector.cpp moc/moc_SensorsListener.cpp moc/moc_MainForm.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc/moc_IP4Validator.cpp moc/moc_PortValidator.cpp moc/moc_RemoteConnector.cpp moc/moc_SensorsConnector.cpp moc/moc_SensorsListener.cpp moc/moc_MainForm.cpp
...
moc/moc_SensorsListener.cpp: SensorsListener.hpp
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) SensorsListener.hpp -o moc/moc_SensorsListener.cpp
...
build/Debug/GNU-Linux-x86/SensorsListener.o: SensorsListener.cpp SensorsListener.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/Debug/GNU-Linux-x86/SensorsListener.o SensorsListener.cpp
...
build/Debug/GNU-Linux-x86/moc_SensorsListener.o: moc/moc_SensorsListener.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/Debug/GNU-Linux-x86/moc_SensorsListener.o moc/moc_SensorsListener.cpp
