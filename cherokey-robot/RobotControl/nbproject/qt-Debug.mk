...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Wed Dec 25 16:37:53 2013
...
INCPATH       = -I/usr/share/qt4/mkspecs/linux-g++-64 -Inbproject -I/usr/include/qt4/QtCore -I/usr/include/qt4/QtGui -I/usr/include/qt4 -Iui -Imessages -I../../3pty/include -Imoc -Iui -I.
LINK          = g++
LFLAGS        = -m64
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -lprotobuf -lzmq -lQtGui -lQtCore -lpthread 
AR            = ar cqs
RANLIB        = 
QMAKE         = /usr/bin/qmake
TAR           = tar -cf
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/Debug/GNU-Linux-x86/RobotControl1.0.0/ && $(COPY_FILE) --parents Commands.hpp RemoteConnector.hpp SensorsListener.hpp messages/common.pb.h messages/sensors.pb.h ui/MainForm.hpp build/Debug/GNU-Linux-x86/RobotControl1.0.0/ && $(COPY_FILE) --parents Commands.cpp RemoteConnector.cpp SensorsListener.cpp main.cpp messages/common.pb.cc messages/sensors.pb.cc ui/MainForm.cpp build/Debug/GNU-Linux-x86/RobotControl1.0.0/ && $(COPY_FILE) --parents ui/MainForm.ui build/Debug/GNU-Linux-x86/RobotControl1.0.0/ && (cd `dirname build/Debug/GNU-Linux-x86/RobotControl1.0.0` && $(TAR) RobotControl1.0.0.tar RobotControl1.0.0 && $(COMPRESS) RobotControl1.0.0.tar) && $(MOVE) `dirname build/Debug/GNU-Linux-x86/RobotControl1.0.0`/RobotControl1.0.0.tar.gz . && $(DEL_FILE) -r build/Debug/GNU-Linux-x86/RobotControl1.0.0
