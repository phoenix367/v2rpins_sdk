...
# Generated by qmake (2.01a) (Qt 4.6.2) on: ?? ???. 20 01:48:21 2014
...
INCPATH       = -I/usr/share/qt4/mkspecs/linux-g++ -Inbproject -I/usr/include/qt4/QtCore -I/usr/include/qt4/QtGui -I/usr/include/qt4/QtOpenGL -I/usr/include/qt4 -Iui -Imessages -I../../3pty/include -I/usr/X11R6/include -Imoc -Iui -I.
LINK          = g++
LFLAGS        = 
LIBS          = $(SUBLIBS)  -L/usr/lib -L/usr/X11R6/lib -lprotobuf -lzmq -lQtOpenGL -lQtGui -lQtCore -lGLU -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
QMAKE         = /usr/bin/qmake
TAR           = tar -cf
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) nbproject/build/Debug/GNU-Linux-x86/RobotControl1.0.0/ && $(COPY_FILE) --parents Commands.hpp Globals.hpp IP4Validator.hpp PlatformModel.hpp PortValidator.hpp RemoteConnector.hpp SensorsConnector.hpp messages/common.pb.h messages/sensors.pb.h ui/MainForm.hpp nbproject/build/Debug/GNU-Linux-x86/RobotControl1.0.0/ && $(COPY_FILE) --parents Commands.cpp IP4Validator.cpp PlatformModel.cpp PortValidator.cpp RemoteConnector.cpp SensorsConnector.cpp main.cpp messages/common.pb.cc messages/sensors.pb.cc ui/MainForm.cpp nbproject/build/Debug/GNU-Linux-x86/RobotControl1.0.0/ && $(COPY_FILE) --parents ui/MainForm.ui nbproject/build/Debug/GNU-Linux-x86/RobotControl1.0.0/ && (cd `dirname nbproject/build/Debug/GNU-Linux-x86/RobotControl1.0.0` && $(TAR) RobotControl1.0.0.tar RobotControl1.0.0 && $(COMPRESS) RobotControl1.0.0.tar) && $(MOVE) `dirname nbproject/build/Debug/GNU-Linux-x86/RobotControl1.0.0`/RobotControl1.0.0.tar.gz . && $(DEL_FILE) -r nbproject/build/Debug/GNU-Linux-x86/RobotControl1.0.0
