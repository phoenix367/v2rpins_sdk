...
INCLUDEPATH += ui messages ../qwtplot3d/include 
LIBS += -lprotobuf -lzmq -lGLU ../qwtplot3d/dist/Debug/GNU-Linux-x86/libqwtplot3d.a -lboost_filesystem -lboost_system -lboost_regex  
