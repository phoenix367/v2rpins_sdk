...
${OBJECTDIR}/src/dev_helper.o: src/dev_helper.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -s -Iinclude -std=c++0x -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/dev_helper.o src/dev_helper.cpp
...
${OBJECTDIR}/src/pwm_factory.o: src/pwm_factory.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -s -Iinclude -std=c++0x -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/pwm_factory.o src/pwm_factory.cpp

${OBJECTDIR}/src/pwm_impl.o: src/pwm_impl.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -s -Iinclude -std=c++0x -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/pwm_impl.o src/pwm_impl.cpp
