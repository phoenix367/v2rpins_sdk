...
${TESTDIR}/tests/PwmIndexTest.o: tests/PwmIndexTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -O2 -s -Iinclude -std=c++0x `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${TESTDIR}/tests/PwmIndexTest.o tests/PwmIndexTest.cpp


${TESTDIR}/tests/pwmindex.o: tests/pwmindex.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -O2 -s -Iinclude -std=c++0x `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${TESTDIR}/tests/pwmindex.o tests/pwmindex.cpp
