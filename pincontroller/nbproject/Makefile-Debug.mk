...
${TESTDIR}/tests/PwmIndexTest.o: tests/PwmIndexTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -g -Werror -Iinclude -std=c++11 `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${TESTDIR}/tests/PwmIndexTest.o tests/PwmIndexTest.cpp


${TESTDIR}/tests/pwmindex.o: tests/pwmindex.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -g -Werror -Iinclude -std=c++11 `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${TESTDIR}/tests/pwmindex.o tests/pwmindex.cpp
